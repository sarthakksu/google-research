...
def is_transition_allowed(constraint_type: str,
    ...
    #    return False
    if to_tag == "[CLS]" or (to_tag == "[PAD]" and not(from_tag == "[SEP]" or from_tag =="[PAD]")) or ((from_tag =="[PAD]" and to_tag !="[PAD]")):
        # Cannot transition into [CLS] or from END
        return False
    if (to_tag == "[PAD]" and (from_tag == "[SEP]" or from_tag =="[PAD]")):
        return True
